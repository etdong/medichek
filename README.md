...
Utilizes mediapipe for hand and face tracking, records the steps taken by the user, then uploads the video to our minio server. It also sends an analysis to our backend for further review.
